...
#[derive(Debug)]
pub struct GatsbyThemeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GatsbyThemeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GatsbyTheme processing");
    
    let mut processor = GatsbyThemeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GatsbyThemeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GatsbyThemeProcessor::new(false);
